...
inline constexpr bool DEBUG_SAVE_AUDIO = true;
inline constexpr std::string_view PIPELINE_TEMP_DIR{"/tmp/audio-pipeline"};
inline constexpr std::string_view DEBUG_AUDIO_DIR{"/home/duan/workspace/audio_debug"};
...
inline constexpr std::string_view TTS_VOICE{"demo-1"};                       // 内置音色
inline constexpr std::string_view TTS_PROMPT_AUDIO{"/home/yu/workspace/prompt_zh.wav"};
...
inline constexpr std::string_view TTS_OUTPUT_DIR{
    DEBUG_SAVE_AUDIO ? "/home/yu/workspace/tts_output"
...
inline constexpr speed_t        UART_BAUD{B460800};
